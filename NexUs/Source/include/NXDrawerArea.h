#ifndef NXFRAMEWORK_NXWIDGETTOOLS_INCLUDE_NXDRAWERAREA_H_
#define NXFRAMEWORK_NXWIDGETTOOLS_INCLUDE_NXDRAWERAREA_H_
...
#endif //NXFRAMEWORK_NXWIDGETTOOLS_INCLUDE_NXDRAWERAREA_H_
