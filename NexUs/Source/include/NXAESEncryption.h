...
public:
     ...
     */
    static QByteArray Crypt(NXAESEncryption::Aes level, NXAESEncryption::Mode mode, const QByteArray& rawText, const QByteArray& key,
        const QByteArray& iv = QByteArray(), NXAESEncryption::Padding padding = NXAESEncryption::ISO);
    /*!
     ...
     */
    static QByteArray Decrypt(NXAESEncryption::Aes level, NXAESEncryption::Mode mode, const QByteArray& rawText, const QByteArray& key,
        const QByteArray& iv = QByteArray(), NXAESEncryption::Padding padding = NXAESEncryption::ISO);
    /*!
     ...
     */
    static QByteArray ExpandKey(NXAESEncryption::Aes level, NXAESEncryption::Mode mode, const QByteArray& key, bool isEncryptionKey);
    ...
    NXAESEncryption(NXAESEncryption::Aes level, NXAESEncryption::Mode mode,
