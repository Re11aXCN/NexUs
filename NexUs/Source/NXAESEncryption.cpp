 ...
 * Static Functions
 * */
QByteArray NXAESEncryption::Crypt(NXAESEncryption::Aes level, NXAESEncryption::Mode mode, const QByteArray& rawText,
    const QByteArray& key, const QByteArray& iv, NXAESEncryption::Padding padding)
{
    return NXAESEncryption(level, mode, padding).encode(rawText, key, iv);
}

QByteArray NXAESEncryption::Decrypt(NXAESEncryption::Aes level, NXAESEncryption::Mode mode, const QByteArray& rawText,
    const QByteArray& key, const QByteArray& iv, NXAESEncryption::Padding padding)
{
    return NXAESEncryption(level, mode, padding).decode(rawText, key, iv);
}

QByteArray NXAESEncryption::ExpandKey(NXAESEncryption::Aes level, NXAESEncryption::Mode mode, const QByteArray& key, bool isEncryptionKey)
{
...
NXAESEncryption::NXAESEncryption(Aes level, Mode mode,
    Padding padding)
