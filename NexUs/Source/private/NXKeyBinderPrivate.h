#ifndef NXWIDGETTOOLS_SRC_PRIVATE_NXKEYBINDERPRIVATE_H_
#define NXWIDGETTOOLS_SRC_PRIVATE_NXKEYBINDERPRIVATE_H_
...
#endif //NXWIDGETTOOLS_SRC_PRIVATE_NXKEYBINDERPRIVATE_H_
