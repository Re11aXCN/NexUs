...
void NXThemePrivate::_initThemeColor()
{
    ...
    _lightThemeColorList[NXThemeType::WindowCentralStackBase] = QColor(0xFF, 0xFF, 0xFF, 120);
    ...
    _lightThemeColorList[NXThemeType::BasicBase] = QColor(0xFF, 0xFF, 0xFF);
    ...
    _lightThemeColorList[NXThemeType::BasicPress] = QColor(0xEA, 0xEA, 0xEA);
    ...
    _lightThemeColorList[NXThemeType::BasicChute] = QColor(0xD6, 0xD6, 0xD6);
    ...
    _darkThemeColorList[NXThemeType::BasicBaseAlpha] = QColor(0x45, 0x45, 0x45, 95);
    ...
    _lightThemeColorList[NXThemeType::BasicHoverAlpha] = QColor(0xCC, 0xCC, 0xCC, 60);
    ...
    _lightThemeColorList[NXThemeType::BasicSelectedAlpha] = QColor(0xCC, 0xCC, 0xCC, 60);
