    ...
    : QWidget{parent}
{
    ...
    NXText* updateTitle = new NXText("2025-1-23更新", 15, this);
    NXText* update1 = new NXText("1、大幅优化了项目的编译体验~", 13, this);
    NXText* update2 = new NXText("2、NXPacketIO库正式发布！该库为基于包定义的轻量级RPC库，基于波音的Afsim拆离派生而来；详情请进群了解~", 13, this);
    NXText* update3 = new NXText("3、新增UDP分布式视频流传输例子，使用NXPacketIO~", 13, this);
    NXText* update4 = new NXText("4、QQ交流群: 850243692", 13, this);
